    ...
    return (
        <div>
            ...
            {candidateList?.map((candidate, index) => (
                <div key={index} className='p-5 flex gap-3 items-center justify-between bg-white rounded-lg mb-5'>
                    ...
                    <div className='flex gap-3 items-center'>
                        <h2 className='text-primary text-lg font-bold'><span>{candidate?.feedback?.feedback?.rating?.overallRating}/10</span></h2>
